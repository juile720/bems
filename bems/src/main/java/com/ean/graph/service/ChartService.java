...
public class ChartService {
	...
	public dataVO getTotalPageTopGraph(){
    	...
    	List<String> y3 = new ArrayList<String>(); // y값 수도
		...
		try {
        	...
        	list.add(new SeriesBean("전기","#a3fe00","column",dat));
    		...
    		dat = new double[y2.size()];
       		...
       		list.add(new SeriesBean("가스","#ffc702","spline",dat));
    		...
    		dat = new double[y3.size()];
       		...
       		list.add(new SeriesBean("수도","#3dddf7","spline",dat));
...
*/        	
    		...
    		dat = new double[y3.size()];
       		...
       		list.add(new SeriesBean("급탕","#00b19d","column",dat));
	...
	public dataVO getEnergyResourceFirstGraph(String gb, String day1, String day2){
    	...
    	List<String> y31 = new ArrayList<String>(); // y값 수도금액
		...
		try {
    		...
    		dat = null; dat = new double[y3.size()];
       		...
       		list.add(new SeriesBean("수도","#3dddf7","column",dat));
    		dat = null; dat = new double[y3.size()];
       		for (int y=0; y<y3.size(); y++){
       			dat[y] = Double.parseDouble(y3.get(y)) ;
        	}
       		list.add(new SeriesBean("수도val","#3dddf7","column",dat));
       		dat = null; dat = new double[y31.size()];
       		for (int y=0; y<y31.size(); y++){
        		dat[y] = Double.parseDouble(y31.get(y));
        	}
       		list.add(new SeriesBean("수도금액","#3dddf7","column",dat));
